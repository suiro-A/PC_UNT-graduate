            ...
            <div class="p-6 space-y-6">
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="firstName" name="firstName" value="Patricia" required class="w-full h-11 px-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>

                    <div class="space-y-2">
                        <label for="lastName" class="block text-sm font-medium text-gray-700">Apellidos *</label>
                        <input type="text" id="lastName" name="lastName" value="Flores Mendoza" required class="w-full h-11 px-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="patricia.flores@unitru.edu.pe" required class="w-full h-11 pl-10 pr-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
